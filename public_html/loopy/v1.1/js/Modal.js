...
function Modal(loopy){
	...
	(function(){
		...
		label.innerHTML = "need ideas for simulations? check out <span style='text-decoration:underline; cursor:pointer' onclick='publish(\"modal\",[\"examples\"])'>مثال‌ها!</span>";
	...
	(function(){
		...
		label.innerHTML = "<br><br>(\n" +
            "توجه داشته باشید: دکمه REMIX اجازه می دهد تا شخص دیگری، مدل شما را ریمیکس کند! نگران نباشید، فقط یک نسخه کپی خواهد بود،و روی نسخه اصلی تاثیر نمی گذارد.)";
		sidebar.appendChild(label);
