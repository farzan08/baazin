...
function Sidebar(loopy){
	...
	(function(){
		...
		page.addComponent(new ComponentHTML({
			...
			"<b style='font-size:1.4em'>لوپی</b><br>لوپی یک ابزار برای تفکر در سیستم ها<br><br>"+

			"<span class='mini_button' onclick='publish(\"modal\",[\"examples\"])'>مشاهده مثال‌ها</span> "+
			"<span class='mini_button' onclick='publish(\"modal\",[\"howto\"])'>چگونه...</span> "+
			"<span class='mini_button' onclick='publish(\"modal\",[\"credits\"])'>credits</span><br><br>"+

			"<hr/><br>"+

			"<span class='mini_button' onclick='publish(\"modal\",[\"save_link\"])'>ذخیره لینک</span> <br><br>"+
			//"<span class='mini_button' onclick='publish(\"modal\",[\"save_image\"])'>save as image</span> <br><br>"+
			"<span class='mini_button' onclick='publish(\"modal\",[\"embed\"])'>کد embed برای سایت شما</span> <br><br>"+
			"<span class='mini_button' onclick='publish(\"modal\",[\"save_gif\"])'>ساختن گیف</span> <br><br>"+
